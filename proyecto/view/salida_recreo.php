<h2 id='letra2' class="text-center w-100">Introduce la tarjeta para salir al recreo</h2>
<div id='divcentral' class='container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center'>
    <div class='d-flex justify-content-center'>
        <div id='divcentral2' class='text-center'>
            <form action='index.php?controller=tarjeta&action=permiso_salida' method='post' enctype='multipart/form-data' id='import_form'>
