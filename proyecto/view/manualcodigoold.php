...
<body>
    <div class="container">
        <ol>
            <li>
                <p>El código del código de barras será el precio del producto en céntimos. Por ejemplo:</p>
                <div class="example">
                    <?php
                    $examples = [
                        "0,50€ → 050",
            ...
            <li><p>Tras la creación del nuevo código, abriremos la aplicación iPrint&Label.</p></li>
            <li><p>Seleccionaremos la sección 'Mis etiquetas'.</p></li>
            <li><p>Elegiremos el modelo de etiqueta deseado.</p></li>
            <li><p>Pulsaremos el botón '+' para añadir el nuevo código de barras.</p></li>
            <li><p>Seleccionaremos el formato de código de barras Code 128.</p></li>
            <li><p>Escribiremos el nuevo código creado y pulsaremos 'Listo'.</p></li>
            <li><p>Colocaremos el código de barras creado en nuestra etiqueta.</p></li>
            <li><p>Finalmente, pulsaremos el botón de 'Guardar'.</p></li>
        </ol>
    </div>
</body>
</html>
