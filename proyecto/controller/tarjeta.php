...
class TarjetaController
{
    ...
    public function form()
    {
        ...
        $this->page_title = 'Bienvenid@ a la intranet';
    }
    ...
    private function getPerfilView(int $idPerfil): void
    {
	    ...
	    case '4':
                ...
                break;
	    case '5':
                $this->view = 'index_secretario';
                $this->page_title = 'ZONA SECRETARIO';
                break;
            default:
                $this->view = 'login_principal';
                $this->page_title = 'INSERTE TARJETA';
...
public function manualcodigo()
    {
        $this->view = 'manualcodigo';
        $this->page_title = 'Manual Tecnico de Creacion de Codigo de Barras';
    }
...
public function recarga()
    {
        $this->view = 'recarga';
        $this->page_title = 'Recarga de Saldo de Tarjetas NFC';
    }
...
public function prueba()
    {
        $this->view = 'prueba';
        $this->page_title = 'Laboratorio de Pruebas';
    }
...
public function saldo()
    {
        $this->view = 'saldo';
        $this->page_title = 'Saldo de la Tarjeta';
    }
...
public function takeaway()
    {
        $this->view = 'takeaway';
        $this->page_title = 'Bienvenido/a a Takeaway';
    }

// Takeaway
// Takeaway secretario

public function takeawaysecretario()
    {
        $this->view = 'takeawaysecretario';
        $this->page_title = 'Bienvenido/a a Takeaway';
    }
...
public function takeawaykiosko()
    {
        $this->view = 'takeawaykiosko';
        $this->page_title = 'Bienvenido/a a Takeaway';
    }
...
public function seleccionarsaldo()
    {
        $this->view = 'seleccionarsaldo';
        $this->page_title = 'Seleccione saldo';
    }
...
public function indextienda()
    {
        $this->view = 'indextienda';
        $this->page_title = 'Tienda de afuera';
    }
...
public function checkout()
    {
        $this->view = 'checkout';
        $this->page_title = 'Gracias por su compra';
    }

// Checkout
// Takeaway exterior

public function takeawayexterior()
    {
        $this->view = 'takeawayexterior';
        $this->page_title = 'Bienvenido/a a Takeaway';
    }
...
public function checkoutexterior()
    {
        $this->view = 'checkoutexterior';
        $this->page_title = 'Gracias por su compra';
    }
...
public function anadircodigo()
    {
        $this->view = 'anadircodigo';
        $this->page_title = 'Añadir código';
    }
