		...
		<div class="masthead">
			<header class="mb-5">
				<div class="p-5 text-center" style="margin-top: 58px;">
					<h1 class="mb-3">Recarga de Saldo de Tarjetas NFC</h1>
				</div>
			</header>
...
<h2>Introducir número de tarjeta a recargar</h2>
    <form action="seleccionarsaldo.php" method="post">
        <label for="numeroTarjeta">Número de Tarjeta:</label>
        <input type="text" id="numeroTarjeta" name="numeroTarjeta" autofocus required>
